...
def local_ats_engine(resume_text, job_desc):
    ...
    stop_words = {
        'should', 'looking', 'basic', 'knowledge', 'required', 'members', 'work', 
        'candidate', 'ability', 'skills', 'using', 'working', 'experience', 
        'years', 'strong', 'excellent', 'written', 'verbal', 'communication',
        'plus', 'preferred', 'requirements', 'responsibilities', 'provide',
        'applications', 'maintain', 'develop', 'engineer', 'software', 'team',
        'programming', 'databases', 'problem', 'solving', 'related', 'test'
    }
    ...
    total_score = int((keyword_score * 0.5) + (impact_score * 0.3) + (readability_score * 0.2))

    return {
        "ats_score": total_score,
        "sub_scores": { "keywords": keyword_score, "impact": impact_score, "readability": readability_score },
        "strengths": ["Clear document structure", "Professional formatting detected"],
        "weaknesses": ["Low impact verb density", "Missing core technical industry terms"],
